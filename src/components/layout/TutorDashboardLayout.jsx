      ...
      <div className='sticky top-0'>
          ...
          <div className='h-[104px] w-[100%] px-[64px] sm:px-[48px] xsm:px-[32px] bg-[white] z-[1000] flex items-center justify-between'>
            ...
            <div className='flex items-center gap-[22px] xsm:hidden sm:hidden md:hidden'>
              ...
              <div className='flex gap-[12px] items-center'>
                ...
                <Link href='/tutor-dashboard/chat'>
                ...
                <Link href='/tutor-dashboard/setting'>
            ...
            <div className='hidden cursor-pointer xsm:block sm:block md:block'>
              {/* <Image src={burgerMenu} onClick={() => setShowMenu(true)} className='cursor-pointer' alt="" /> */}
        ...
        <div className='flex justify-between bg-primary2 pr-[61px] pl-[64px] py-[10px] xsm:pl-[32px] sm:pl-[48px]'>
          <div className='flex items-center gap-[29px]'>
            <Link href='/tutor-dashboard' className={pathname === '/tutor-dashboard' ? "font-outfit font-[600] text-[16px] leading-[18.31px] text-[white]" : "font-outfit font-[600] text-[16px] leading-[18.31px] text-primaryLighten2"}>Lessons</Link>
            <Link href='/tutor-dashboard/chat' className={pathname === '/tutor-dashboard/chat' ? "font-outfit font-[600] text-[16px] leading-[18.31px] text-[white]" : "font-outfit font-[600] text-[16px] leading-[18.31px] text-primaryLighten2"}>Messages</Link>
            <Link href='/tutor-dashboard/calender' className={pathname === '/tutor-dashboard/calender' ? "font-outfit font-[600] text-[16px] leading-[18.31px] text-[white]" : "font-outfit font-[600] text-[16px] leading-[18.31px] text-primaryLighten2"}>Calender</Link>
            <Link href='/tutor-dashboard/statistics' className={pathname === '/tutor-dashboard/statistics' ? "font-outfit font-[600] text-[16px] leading-[18.31px] text-[white]" : "font-outfit font-[600] text-[16px] leading-[18.31px] text-primaryLighten2"}>Statistics</Link>
            <Link href='/tutor-dashboard/my-profile' className={pathname === '/tutor-dashboard/my-profile' ? "font-outfit font-[600] text-[16px] leading-[18.31px] text-[white]" : "font-outfit font-[600] text-[16px] leading-[18.31px] text-primaryLighten2"}>My profile</Link>
            <Link href='/tutor-dashboard/groups' className={pathname === '/tutor-dashboard/groups' ? "font-outfit font-[600] text-[16px] leading-[18.31px] text-[white]" : "font-outfit font-[600] text-[16px] leading-[18.31px] text-primaryLighten2"}>Groups</Link>
          </div>
