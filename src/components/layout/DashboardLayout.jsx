      ...
      <div className='sticky top-0'>
        ...
        <div className='flex justify-between bg-primary2 pr-[61px] pl-[64px] py-[10px] xsm:pl-[32px] sm:pl-[48px]'>
          <div className='flex items-center gap-[29px]'>
            <Link href='/student-dashboard' className={pathname === '/student-dashboard' ? "font-outfit font-[600] text-[16px] leading-[18.31px] text-[white]" : "font-outfit font-[600] text-[16px] leading-[18.31px] text-primaryLighten2"}>Lessons</Link>
            <Link href='/student-dashboard/chat' className={pathname === '/student-dashboard/chat' ? "font-outfit font-[600] text-[16px] leading-[18.31px] text-[white]" : "font-outfit font-[600] text-[16px] leading-[18.31px] text-primaryLighten2"}>Messages</Link>
          </div>
