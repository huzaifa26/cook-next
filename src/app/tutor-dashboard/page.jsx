...
export default function Page() {
  const [tab, setTab] = useState('Upcoming Classes');
  const [tab2, setTab2] = useState('Active students');
  return (
    <>
          ...
          <div className='flex gap-[24px] xsm:gap-[16px] xsm:flex-col sm:flex-col md:flex-col'>
            <div className='p-[16px] pr-0 bg-primaryLighten flex gap-[24px]'>
              ...
              <div className='flex flex-col '>
                ...
                <p className='font-outfit mt-[4px] xsm:mt-[8px] text-[16px] text-TextColorSec'>The number of students learning with you</p>
              </div>
            </div>
            <div className='p-[16px] pr-0 bg-primaryLighten flex gap-[24px]'>
              <svg className='max-w-[80px] max-h-[80px]' width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='flex flex-col mt-[100px] xsm:mt-[103px] gap-[112px] xsm:gap-[68px]'>
          <div className='flex flex-col gap-[37px] xsm:gap-[29px]'>
            <div className='flex gap-[42px] items-center'>
              <h2 onClick={() => setTab("Upcoming Classes")} className={tab === "Upcoming Classes" ? 'font-rubik font-semibold text-[28px] leading-[31.72px] tracking-[-0.02em] xsm:text-[24px] xsm:leading-[27.19px] border-b-2 border-primaryLighten2 pb-[8px] cursor-pointer transition-all duration-200' : 'pb-[8px] cursor-pointer transition-all duration-200 border-b-2 border-[white] font-rubik font-semibold text-[28px] leading-[31.72px] tracking-[-0.02em] xsm:text-[24px] xsm:leading-[27.19px] opacity-[0.5]'}>Upcoming Classes</h2>
              <h2 onClick={() => setTab("Past Lessons")} className={tab === "Past Lessons" ? 'font-rubik font-semibold text-[28px] leading-[31.72px] tracking-[-0.02em] xsm:text-[24px] xsm:leading-[27.19px] border-b-2 border-primaryLighten2 pb-[8px] cursor-pointer transition-all duration-200' : 'pb-[8px] cursor-pointer transition-all duration-200 border-b-2 border-[white] font-rubik font-semibold text-[28px] leading-[31.72px] tracking-[-0.02em] xsm:text-[24px] xsm:leading-[27.19px] opacity-[0.5]'}>Past Lessons</h2>
            </div>
          ...
          <div className='flex flex-col gap-[37px] xsm:gap-[29px]'>
            <div className='flex gap-[42px] items-center'>
              <h2 onClick={() => setTab2("Active students")} className={tab2 === "Active students" ? 'font-rubik font-semibold text-[28px] leading-[31.72px] tracking-[-0.02em] xsm:text-[24px] xsm:leading-[27.19px] border-b-2 border-primaryLighten2 pb-[8px] cursor-pointer transition-all duration-200' : 'pb-[8px] cursor-pointer transition-all duration-200 border-b-2 border-[white] font-rubik font-semibold text-[28px] leading-[31.72px] tracking-[-0.02em] xsm:text-[24px] xsm:leading-[27.19px] opacity-[0.5]'}>Active students</h2>
              <h2 onClick={() => setTab2("Archived students")} className={tab === "Archived students" ? 'font-rubik font-semibold text-[28px] leading-[31.72px] tracking-[-0.02em] xsm:text-[24px] xsm:leading-[27.19px] border-b-2 border-primaryLighten2 pb-[8px] cursor-pointer transition-all duration-200' : 'pb-[8px] cursor-pointer transition-all duration-200 border-b-2 border-[white] font-rubik font-semibold text-[28px] leading-[31.72px] tracking-[-0.02em] xsm:text-[24px] xsm:leading-[27.19px] opacity-[0.5]'}>Archived students</h2>
            </div>
            <div className='flex flex-col gap-[12px] xsm:gap-[14px]'>
              {[1, 2, 3].map((val, index) => {
                return (
