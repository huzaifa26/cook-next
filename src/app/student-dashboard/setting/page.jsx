      ...
      <div className='flex justify-between'>
        <div className='flex flex-col gap-[32px]'>
          <div className='flex flex-col gap-[12px]'>
            ...
            <input onChange={(e) => setName(e.target.value)} className='w-[26.875vw] font-outfit outline-primary2 text-[20px] font-normal leading-[113.3%] p-[12px] rounded-[4px] border border-primaryLighten2' placeholder='Name' defaultValue={user?.name} />
          </div>
          <div className='flex flex-col gap-[12px]'>
        ...
        {session?.data?.data?.picture ?
          <>
            ...
            <label htmlFor='image1'>
              <Image loader={() => session?.data?.data?.picture} className='rounded-full object-cover max-w-[226px] max-h-[226px]' width={226} height={226} src={user?.picture} alt='' priority />
            </label>
          </>
          :
          <>
            ...
            <label htmlFor='image2'>
              <Image className='rounded-full object-cover max-w-[226px] max-h-[226px]' width={226} height={226} src={image ? URL.createObjectURL(image) : LoginProfile} alt='' priority />
            </label>
          </>
        }
      </div>
