      ...
      <div className='ml-[3.264vw] mr-[3.889vw] my-[43px] xsm:ml-0 xsm:mr-0'>
        <div>
          ...
          <div className="flex items-center gap-[12px] mt-[10px]">
            <input onChange={(e) => setPrice(e.target.value)} className="!w-[102px] bg-[rgba(0,0,0,0)] h-[38px] p-[9px] flex justify-center items-center font-outfit text-[16px] font-medium leading-normal border border-primaryLighten2 outline-primary2 text-center" placeholder="20" type="number" />
        ...
        <div className='mt-[95px] xsm:mt-[42px] flex justify-between relative'>
          ...
          <button onClick={() => priceFormHandler()} className="transition-all duration-200 bg-primary2 hover:bg-[rgba(0,0,0,0)] border-2 border-primary2 text-[white] hover:text-primary2 w-[128px] py-[8px] font-outfit text-[18px] leading-normal font-medium rounded-[4px]">Finish</button>
          {error &&
