    ...
    <>
      ...
      <div className='ml-[3.264vw] mr-[3.889vw] xsm:ml-0 xsm:mr-0 my-[43px]'>
        <div className='flex xsm:flex-col gap-[21px] items-center h-fit'>
          <label htmlFor='video' className="group bg-[rgba(0,0,0,0)] hidden xsm:flex xsm:w-full items-center gap-[8px] justify-center w-[163px] transition-all duration-200 bg-[white] hover:bg-primary2 border border-primary2 text-primary2 hover:text-[white] py-[8px] font-outfit text-[18px] leading-normal font-medium rounded-[4px]">
            Record
          ...
          <div className='xsm:w-full'>
            ...
            <div className='mt-[51px] xsm:mt-[0px] flex flex-col gap-[22px]'>
              ...
              <input defaultValue={(typeof window !== "undefined" && checkFileType(video)) ? null : video} onChange={youtubeLinkHandler} className='w-[23.889vw] bg-[rgba(0,0,0,0)] xsm:w-full h-[46px] p-[10px] border border-primaryLighten2 outline-primary2 rounded-[8px] font-outfit text-[16px] font-normal leading-[160%]' placeholder={'https:'} />
            </div>
          </div>
        </div>
