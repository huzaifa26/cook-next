...
export default function RootLayout({children}) {
  ...
  return (
    <>
      <nav className=' z-40 h-[84px] w-[100%] px-[64px] xsm:px-[32px] flex items-center bg-primary2 justify-between'>
        ...
        <div className='flex items-center'>
          ...
          <Link href='/support'>
            <div className='custom-tooltip ml-[40px]' data-tooltip="Support">
